...
public class DetailedAltitudeGraphActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnCameraMoveListener, GoogleMap.OnCameraIdleListener {
    ...
    private void setData() {
        ...
        if (sizeOfList != 0) {
            for (Run run : run) {
                ...
                float altitude = (float) run.getAltitude();
                values.add(new Entry(coveredMeter, altitude));
                //    i++;
                //}
                //i++;
            }
