...
public class SharedPref {
    ...
    public final static String STATIC_STRING_MINIMUM_SPEED_LIMIT = "MINIMUM_SPEED_LIMIT"; //minimum speed limit is always m/s

    public static final  String STATIC_BROADCAST_ACTION = "at.co.netconsulting.polylinepoints";
